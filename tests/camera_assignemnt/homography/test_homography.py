...
@pytest.fixture
def court_ref():
    from src.camera_assignemnt.homography.court_reference import load_court_reference
...
def test_homography_estimator_synthetic(court_ref):
    from src.camera_assignemnt.homography.config import HomographyConfig
    from src.camera_assignemnt.homography.homography_estimator import estimate_homography_from_keypoints
    from src.camera_assignemnt.homography.types import KeypointDetection
...
def test_validator_synthetic():
    from src.camera_assignemnt.homography.homography_validator import passes_exact_gate
...
def test_keypoint_detector_on_sample():
    from src.camera_assignemnt.homography.config import HomographyConfig
    from src.camera_assignemnt.homography.keypoint_detector import detect_court_keypoints
